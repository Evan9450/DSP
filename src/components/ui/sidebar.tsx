  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "relative flex h-screen w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground transition-all duration-200 ease-in-out group/sidebar",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100vh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
        className
      )}
      {...props}
    />
