...
export interface Vehicle {
  ...
  vehicleNumber: string; // Display name
  brand?: string;
  model?: string;
  condition: VehicleCondition; // red=unavailable, yellow=needs-repair, green=available
...
export interface Reminder {
  id: string;
  type: 'document-expiry' | 'vehicle-maintenance' | 'low-stock' | 'schedule-confirmation';
